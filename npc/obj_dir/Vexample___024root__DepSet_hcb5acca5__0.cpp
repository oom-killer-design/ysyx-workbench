...
VL_INLINE_OPT void Vexample___024root___nba_sequent__TOP__0(Vexample___024root* vlSelf) {
    ...
    __Vdly__top__DOT__count_c = 0;
    // Body
    __Vdly__top__DOT__count_c = vlSelf->top__DOT__count_c;
    __Vdly__top__DOT__count_c = ((IData)(1U) + vlSelf->top__DOT__count_c);
    if (VL_UNLIKELY((3U <= vlSelf->top__DOT__count_c))) {
        VL_FINISH_MT("vsrc/example.v", 28, "");
    }
...
#endif
                VL_FATAL_MT("vsrc/example.v", 9, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/example.v", 9, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/example.v", 9, "", "NBA region did not converge.");
            }
